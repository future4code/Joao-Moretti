...
//       verificaA(usuario[0].texto, usuario[1].texto)
//       verificaA(computador[0].texto, computador[1].texto)
...
//       let novo - []
//       while (confirm === true){
//         confirm(`Suas cartas são ${usuario[0].texto}, ${usuario[1].texto}. A carta do computador é ${computador[0].texto}
// Deseja comprar mais uma carta?`)

//         novo = resultadoUsuario.push(comprarCarta())
//         resultadoUsuario
